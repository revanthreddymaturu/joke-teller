...
function callVoiceSdk(jokeData){

    VoiceRSS.speech({
        key: '2c49455480894459b60fc2eb5a43b5e5',
        src: `${jokeData.joke}`,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJoke(){
    try{
        const joke=await fetch("https://v2.jokeapi.dev/joke/Programming?blacklistFlags=nsfw,religious,political,racist,sexist,explicit&type=single");
        jokeData=await joke.json();
        callVoiceSdk(jokeData);
        toggleButton();
